...
export function MyCollaborationsView() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-50/70 via-white to-blue-50/40 pb-16 pt-6 sm:pb-24 sm:pt-10">
      <div className="mx-auto w-full max-w-3xl px-4 sm:px-6 relative">
        ...
        <div className="relative rounded-[1.75rem] border border-orange-200/70 bg-gradient-to-br from-orange-50 via-white to-blue-50 p-6 shadow-[0_0_0_1px_rgba(249,115,22,0.18),0_18px_40px_rgba(2,132,199,0.14)] sm:p-8 overflow-hidden">
          <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-blue-200/30 via-white to-orange-200/30 opacity-95" />
          ...
          <div className="mt-6 space-y-5">
            ...
            <div>
              ...
              <Textarea
                ...
                className="min-h-[140px] rounded-2xl border-orange-200/70 bg-white p-4 text-sm font-medium focus:ring-2 focus:ring-orange-300"
              />
            ...
            <Button
              ...
              className="w-full rounded-2xl bg-gradient-to-r from-orange-500 via-orange-500 to-blue-600 py-6 font-black text-[10px] uppercase tracking-widest text-white hover:opacity-95 sm:w-auto sm:px-12 transition-colors shadow-lg shadow-orange-200/60"
            >
